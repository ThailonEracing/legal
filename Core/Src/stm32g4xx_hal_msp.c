...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = IR1_AD_Pin|IR_Fr_AD_Pin;
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = IR2_AD_Pin|GPIO_PIN_7;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, IR1_AD_Pin|IR_Fr_AD_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(GPIOA, IR2_AD_Pin|GPIO_PIN_7);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(IR3_AD_GPIO_Port, IR3_AD_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(IR4_AD_GPIO_Port, IR4_AD_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    HAL_GPIO_DeInit(IR5_AD_GPIO_Port, IR5_AD_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    /* I2C2 DMA Init */
    /* I2C2_RX Init */
    hdma_i2c2_rx.Instance = DMA2_Channel1;
    ...
    /* I2C2_TX Init */
    hdma_i2c2_tx.Instance = DMA2_Channel2;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, HC05_RX_Pin|HC05_TX_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA4     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = Ultra_Eco_TIM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(Ultra_Eco_TIM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM20_MspPostInit 0 */
    ...
    PB2     ------> TIM20_CH1
    */
    GPIO_InitStruct.Pin = Ultra_Trig_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM20;
    HAL_GPIO_Init(Ultra_Trig_PWM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA4     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(Ultra_Eco_TIM_GPIO_Port, Ultra_Eco_TIM_Pin);
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(Encoder_Esq_TIM_GPIO_Port, Encoder_Esq_TIM_Pin);
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PB5     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(Encoder_Dir_TIM_GPIO_Port, Encoder_Dir_TIM_Pin);
